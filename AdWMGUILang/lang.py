...
if userLang == "en" or userLang == "EN" or userLang == "English":
    ...
    about_zero_level_title = "AdWMGUI (Advanced Windows Manager GUI) version: 1.3"
    about_one_level_title = "AdWMGUI (Advanced Windows Manager GUI) version: 1.3, version_type: Stable Version (for GUI and Program), licence: GPL2"
...
if userLang == "tr" or userLang == "TR" or userLang == "Türkçe":
    ...
    about_zero_level_title = "AdWMGUI (Gelişmiş Windows Yönetimi GUI) sürüm: 1.3"
    about_one_level_title = "AdWMGUI (Gelişmiş Windows Yönetimi GUI) sürüm: 1.3, sürüm tipi: Stabil sürüm (GUI ve Program için), Lisans: GPL2"
